...
void CrearPiramideTriangular()
{
	...
	GLfloat vertices_piramide_triangular[] = {
		...
		0.0f,-0.5f,-0.5f,	//3
		*/
		//Piramide triangular equilatero
		0.0f, 0.0f, 0.0f,		//0
		-0.5f, 0.0f, -0.866f,	//1
		0.5f, 0.0f, -0.866f,	//2
...
int main()
{
	...
	CrearCilindro(20, 0.25f);//índice 2 en MeshList
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		meshList[1]->RenderMesh();
		/**/
		//--------------------------	Fin de priamides verdes			---------------------------------------- 
		
		//----------------------------------- Inicio piramides rojas ----------------------------------------------
		...
		//--------------------------	Fin de priamides rojas			---------------------------------------- 

		//----------------------------------- Inicio piramides azul ----------------------------------------------
		...
		//--------------------------	Fin de priamides azules			---------------------------------------- 

		//----------------------------------- Inicio piramides amarillas ----------------------------------------------
		...
		//glm::rotate(, glm::radians(angulo), glm::vec3(5.0f, 5.0f, 5.0f));
