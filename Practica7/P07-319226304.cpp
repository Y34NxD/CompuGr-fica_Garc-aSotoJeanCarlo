...
int main()
{
	...
	mainLight = DirectionalLight(1.0f, 1.0f, 1.0f,	//color de la luz
		0.02f, 0.02f,			//Radiación (modifica el reflejo de la luz, primer parametro), segundo parametro componente difusa (tonalidad del color con la luz)
